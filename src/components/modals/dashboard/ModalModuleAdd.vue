...
console.log('Current state of iconPreview:', iconPreview.value);
...
async function createModule() {
  ...
  try {
    ...
    const response = await storeUtils.createModule(formDataUpload);
    console.log('response: ', response)
    
    if (response.status === 201) {
      resetForm();
      modal.handleClickModalModuleAdd();
    } else {
...
<template>
  <div class="modal" v-if="modal.modalModuleAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalModuleAdd(), resetForm()">
        ...
        <hr>
        <form class="form__modal" @submit.prevent="createModule">
          ...
          <!-- <div class="form__modal--field">
            <label class="form__modal--label">Icon: </label>

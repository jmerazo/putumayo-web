...
async function createSubdependencie() {
  ...
  try {
    await storeUtils.createSubdependencie(formData.value);
    resetForm();
    modal.handleClickModalSubdependencieAdd()
  } catch (error) {
...
<template>
  <div class="modal" v-if="modal.modalSubdependencieAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalSubdependencieAdd(), resetForm()">
        ...
        <hr>
        <form class="form__modal" @submit.prevent="createSubdependencie">

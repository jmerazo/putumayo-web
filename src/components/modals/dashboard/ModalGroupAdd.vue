...
async function createGroup() {
  ...
  try {
    await storeUtils.createGroup(formData.value);
    resetForm();
    modal.handleClickModalGroupAdd()
  } catch (error) {
...
<template>
  <div class="modal" v-if="modal.modalGroupAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalGroupAdd(), resetForm()">
        ...
        <hr>
        <form class="form__modal" @submit.prevent="createGroup">

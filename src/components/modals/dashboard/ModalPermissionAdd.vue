...
async function createPermission() {
  ...
  try {
    await storeUtils.createPermission(formData.value);
    resetForm();
    modal.handleClickModalPermissionAdd()
  } catch (error) {
...
<template>
  <div class="modal" v-if="modal.modalPermissionAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalPermissionAdd(), resetForm()">
        ...
        <hr>
        <form class="form__modal" @submit.prevent="createPermission">

...
async function personCreate() {
  ...
  try {
    await person.createPerson(formData.value);
    resetForm();
    modal.handleClickModalPersonAdd()
  } catch (error) {
...
<template>
  <div class="modal" v-if="modal.modalPersonAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalPersonAdd(), resetForm()">
        ...
        <hr>
        <form class="form__modal" @submit.prevent="personCreate">

...
<template>
  <div class="modal" v-if="modal.modalNewsAdd">
    <div class="modal__contenido">
      <div class="form__modal--content">
        <div class="header">
          <button type="button" class="btn__closew" @click="modal.handleClickModalNewsAdd(), resetForm()">
        ...
        <form class="form__modal" @submit.prevent="createNew"  enctype="multipart/form-data">
          ...
          <div class="form__modal--field">
            <label class="form__modal--label">Date publication: </label>
            <input class="form__modal--input" type="date" v-model="formData.publication_date" />
          </div>

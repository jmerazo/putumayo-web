...
<template>
  <div class="users-list">
    <div class="title__users">
        <h3>Groups Putumayo</h3>
    </div>
    <div class="btn__panelUsers">
      <button @click.prevent="modal.handleClickModalGroupAdd()" type="button" class="btn__adduser">
        <img src="/icons/icon_add.svg" class="icon__panel">
      </button>
    </div>    
    <hr class="seccion__divisor">
    <div class="cards-container">
      <div v-for="g in utilsStore.groups" :key="g.id" :value="g.id" class="card">
        <div class="icon__subdependencies">
          <img src="/icons/icon_groups.svg">
        </div>

...
<template>
  <div class="users-list">
    <div class="title__users">
        <h3>Roles Putumayo</h3>
    </div>
    <div class="btn__panelUsers">
      <button @click.prevent="modal.handleClickModalRoleAdd()" type="button" class="btn__adduser">
        <img src="/icons/icon_add.svg" class="icon__panel">
      </button>
    </div>    
    <hr class="seccion__divisor">
    <div class="cards-container">
      <div v-for="r in utilsStore.roles" :key="r.id" :value="r.id" class="card">
        <div class="icon__subdependencies">
          <img src="/icons/icon_user_role.svg">
        </div>
